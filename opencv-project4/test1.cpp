...
int main() {
    ...
    AdaptiveMeanFilter::show("胡椒-", pepperNoise, 7, 10000);
    AdaptiveMeanFilter::show("盐-", saltNoise, 7, 10000);
    AdaptiveMeanFilter::show("椒盐-", saltAndPepperNoise, 7, 10000);

    //自适应中值滤波
    AdaptiveMedianFilter::show("高斯-", pepperNoise, 7, 7);
    AdaptiveMedianFilter::show("胡椒-", pepperNoise, 7, 7);
    AdaptiveMedianFilter::show("盐-", saltNoise, 7, 7);
